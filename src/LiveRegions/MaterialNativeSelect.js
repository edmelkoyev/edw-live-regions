...
const sections = [
    ...
    {id: 'sec02', title: "Biology", message: "22 activities"},
    {id: 'sec03', title: "Chemistry", message: "25 activities"},
    {id: 'sec04', title: "Physics", message: "38 activities"}
]

class MaterialNativeSelect extends PureComponent {
    constructor(props) {
        super(props)
                ...
                <Box p={2}>
                    <Box pb={2}>
                        <FormControl variant="filled">
                            <InputLabel id="demo-native-select-filled-label">Sections</InputLabel>
                            <Select
                                labelId="demo-native-select-filled-label"
                                native
                    ...
                    <Paper>
                        <Box p={2}>
                            ...
                            <Box id="msg01" aria-live="polite">
                                {'NATIVE MESSAGE: ' + this.getMessage(curSection) }
                            </Box>
                        </Box>
                    </Paper>
